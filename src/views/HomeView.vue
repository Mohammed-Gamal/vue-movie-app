<template>
  <div class="home">
    <div class="feature-card">
      <router-link :to="{ name: 'MovieDetail', params: { id: '12312' }}">
        <img
        ...
        <div class="detail">
          <h3>Naruto</h3>
          <p>
            Naruto Uzumaki, a mischievous adolescent ninja, struggles as he searches for recognition and dreams of
    ...
    <div class="movies-list">
      <div
        ...
        :key="movie.imdbID"
      >
        <router-link :to="{ name: 'MovieDetail', params: { id: movie.imdbID } }" class="movie-link">
